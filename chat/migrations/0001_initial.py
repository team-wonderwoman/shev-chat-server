# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-14 07:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='AuthSer.User')),
            ],
        ),
        migrations.CreateModel(
            name='TopicMessage',
